...
centered symmetrical grid with circular photo crops and rounded frames like a retro postcard rack — rounded geometric slab serif (Cooper/Recoleta-style) headlines with playful letterspacing — Palm Springs mid-century palette: dusty stone #B9AF9C, deep pine ink #1C2B22, ivory #EFE9DD, surprise cobalt pop #2B4CFF — optimistic, retro-playful, quietly self-assured
