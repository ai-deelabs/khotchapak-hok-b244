...
full-bleed near-black stage with a single circular spotlight pool framing the speaker, copy pushed to the dark margins — bold condensed uppercase sans (Druk-style) set tight and loud — theatre-spotlight dark mode: charcoal-black #14120F, slate #8A8478, one electric amber spotlight #FFB020 — charged, magnetic, arena-ready adrenaline
