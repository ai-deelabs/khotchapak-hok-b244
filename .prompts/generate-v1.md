...
Brand:
Khotchapak Hok provides training courses for personality development, public speaking, and communication. The brand aesthetic is warm and natural, featuring earthy tones and soft daylight photography.

This is variant 1 of 3.

CREATIVE DIRECTION
A creative director has chosen this direction for variant #1:
asymmetric editorial magazine grid with full-bleed golden-hour photo bleeding off one edge — oversized warm serif headlines (Tiempos-style) paired with tiny tracked-out caps captions — 1970s Big Sur postcard palette: sand #E8DCC8, terracotta #C1673D, umber #4A3428, cream #F5EDE1 — unhurried, contemplative, sun-warmed confidence
